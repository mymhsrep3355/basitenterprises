...
//   // Number of visible items depends on screen size
//   const visibleItems = {
//     base: 1, // Small devices
//     sm: 2, // Tablets
//     md: 3, // Medium devices
//     lg: 5, // Larger devices
//   };
...
//   const handleNext = () => {
//     if (currentIndex + visibleItems.lg < brands.length) {
...
//           color="white"
//           _hover={{ bg: "red.400" }}
//           isDisabled={currentIndex + visibleItems.lg >= brands.length}
//         />
//       </Box>
